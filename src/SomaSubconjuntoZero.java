...
No código o backtracking é usado para encontrar um subconjunto de números que somam zero.
...
que permitem ao algoritmo explorar todas as possibilidades e encontrar todas as soluções possíveis. Embora possa parecer
que a segunda chamada recursiva duplica o trabalho, na verdade é uma maneira eficiente de percorrer o espaço de solução
sem a necessidade de gerar todas as combinações de subconjuntos explicitamente.
